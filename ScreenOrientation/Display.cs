...
public class Display
{
    ...
    public static bool Rotate(uint DisplayNumber, Orientations Orientation)
    {
        ...
        DEVMODE dm2 = new DEVMODE();
        d.cb = Marshal.SizeOf(d);
        d2.cb = Marshal.SizeOf(d2);
        NativeMethods.EnumDisplayDevices(null, 1, ref d2, 0);
        var response = NativeMethods.EnumDisplaySettings(d2.DeviceName, NativeMethods.ENUM_CURRENT_SETTINGS, ref dm2);
